...
public class BookController
{
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Error updating Book", response = ErrorDetail.class)
    } )
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Error adding book", response = ErrorDetail.class)
    } )
    ...
    {
        bookService.savetoAuthor(bookid, authorid);

        return new ResponseEntity<>(HttpStatus.OK);
    }

    @ApiOperation(value = "Deletes a Book", notes = "The book will be deleted from the database.",
                  response = void.class)
    @ApiResponses(value = {
